...
## Corpus Check
- 351 files · ~68,221 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1361 nodes · 2298 edges · 302 communities (238 shown, 64 thin omitted)
...
Cohesion: 0.14
Nodes (17): parseCsvTasklistLine(), parseTasklistOutput(), summarizeTasklistProcesses(), parseWindowsVersionOutput(), summarizeWindowsVersion(), WindowsVersionObservation, normalizeCommand(), NormalizedCommand (+9 more)

### Community 3 - "Approval & Sandbox Policy"
Cohesion: 0.09
Nodes (25): ApprovalPolicy, commandText(), containsShellControlOperator(), DEFAULT_POLICY, isDangerousPowershellCommand(), isPowershellCommandMode(), isPowershellEncodedCommand(), matchesAny() (+17 more)
...
Cohesion: 0.22
Nodes (14): chatsRepo(), handleChatCreate(), handleChatDelete(), handleChatList(), handleMessageCreate(), handleMessageList(), messagesRepo(), getDb() (+6 more)
...
Cohesion: 0.10
Nodes (18): __dirnameFallback(), loadJsonConfig(), ApprovalInsert, ApprovalRow, ApprovalsRepository, isSensitive(), ScopeCheck, SENSITIVE_PREFIXES (+10 more)
...
Cohesion: 0.16
Nodes (9): ActiveRun, AgentOrchestratorOptions, DEFAULT_RUN_OPTIONS, toPublicStatus(), RunReactLoopOptions, getActiveRuntimeModelConfig(), AgentRunStateRepository, AgentRun (+1 more)
...
Cohesion: 0.18
Nodes (11): parseNmapOutput(), extractHost(), TcpPortProbeInput, TcpPortProber, BaseToolIntent, BrowserToolIntent, FilesystemToolIntent, GenericToolIntent (+3 more)
...
Cohesion: 0.32
Nodes (9): approvalTtlMs(), getApprovalService(), getApprovalTimeouts(), buildToolRegistry(), handleApprovalApprove(), handleApprovalList(), handleApprovalReject(), readDecisionPayload() (+1 more)
...
Cohesion: 0.10
Nodes (18): SandboxAuditSink, immediateError(), ALLOWED_ENV_KEYS, buildMinimalEnv(), FilesystemScope, DEFAULT_LIMITS, loadLimits(), normalizeLimits() (+10 more)

### Community 122 - "Module 122"
Cohesion: 0.25
Nodes (7): createMainWindow(), getDbPath(), getMigrationsDir(), config, configDir, db, setDb()
...
Cohesion: 0.15
Nodes (24): accessibilityWeight(), cleanVersion(), CRITICAL_SERVICES, highestRiskPriority(), impactWeight(), isPrivateIp(), mergeRiskInputs(), normalizeService() (+16 more)

### Community 126 - "Community 126"
Cohesion: 0.18
Nodes (12): ApprovalCapableExecutor, ApprovalCoordinator, ApprovalOutcome, ApprovalPersistence, ApprovalRequestInput, noopAuditSink, summarizeIntent(), truncateForAudit() (+4 more)

### Community 128 - "Module 128"
Cohesion: 0.15
Nodes (16): buildChatEndpoint(), buildEmbeddingEndpoint(), extractEmbedding(), extractTextFromStreamingJson(), HttpMode, inferMode(), LlamaCppHttpProvider, makeStableFallbackEmbedding() (+8 more)

### Community 136 - "Module 136"
Cohesion: 0.20
Nodes (11): registerApprovalEventForwarding(), handlers, registerIpcHandlers(), handleSettingsGet(), handleSettingsGetAll(), handleSettingsSet(), AnyChannel, EventChannel (+3 more)

### Community 160 - "Module 160"
Cohesion: 0.07
Nodes (18): ApprovalDialog(), ApprovalDialogProps, RISK_COLORS, useCountdown(), ApprovalQueue(), DECISION_STYLE, ApprovalEmitter, ApprovalEventName (+10 more)
...
Cohesion: 0.18
Nodes (14): api, Window, AgentStartPayload, AgentEventMap, ApprovalEventMap, ExposedApi, IpcChannel, IpcRequest (+6 more)
...
Cohesion: 0.36
Nodes (6): LocalModelRow, UpsertLocalModelInput, ModelProviderType, ModelQuantization, ModelRuntimeDevice, ModelRuntimeState
...
Cohesion: 0.29
Nodes (9): getOrchestrator(), handleAgentGet(), handleAgentStart(), handleAgentStop(), createAuditSink(), AgentGetPayloadSchema, AgentStartPayloadSchema, AgentStopPayloadSchema (+1 more)
...
Cohesion: 0.53
Nodes (5): defaultLlamaServerCandidates(), findExecutableOnPath(), getModelFileInfo(), inferQuantization(), isGgufFile()
...
Cohesion: 0.15
Nodes (6): ModelDownloader, safeFilename(), LocalModelRegistry, mapRow(), ModelsRepository, LocalModelRecord
...
## Knowledge Gaps
- **343 isolated node(s):** `PreToolUse`, `allow`, `PreToolUse`, `defaultDecision`, `criticalPatterns` (+338 more)
...
- **Why does `LocalModelRecord` connect `Community 285` to `Agent Memory & Orchestration`, `Community 202`, `Module 90`, `Community 220`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `MemoryManager` connect `Local HTTP Provider` to `Module 28`, `Community 209`, `Module 87`, `Community 218`, `Module 124`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `AgentOrchestrator` connect `Community 218` to `Agent Tools Registry`, `Local HTTP Provider`, `Community 244`, `Module 87`, `Module 28`, `Community 286`?**
